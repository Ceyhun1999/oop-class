...
<div class="main">
    ...
    <form action="crud/insert.php" method="post" style="max-width: 400px;"  enctype="multipart/form-data">
        ...
        <div>
            <input type="submit" value="Создать слайд" style="padding: 10px 20px; background-color: #3498db; color: #fff; border: none; border-radius: 4px; cursor: pointer;">
        </div>
    </form>
</div>
